...
//	public FenetreNouveauProduit(String[] lesCategories) {
	public FenetreNouveauProduit(ControlleurPrincipal controlleur) {	
...
//		contentPane.add(combo);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btValider) {
			this.controlleur.nouveauProduit(this.txtNom.getText(),Double.parseDouble(this.txtPrixHT.getText()),Integer.parseInt(this.txtQte.getText()));
		}
		this.dispose();
	}
