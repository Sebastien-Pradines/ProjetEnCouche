...
public class FenetrePrincipale extends JFrame implements ActionListener,
	...
	private ControlleurPrincipal controlleur = new ControlleurPrincipal();
...
//		String[] tabCategories = new String[] {"Bio", "Luxe" };
		...
		if (e.getSource() == btAfficher)
			new FenetreAffichage(this.controlleur.afficher());
		if (e.getSource() == btNouveauProduit)
//			new FenetreNouveauProduit(tabCategories);
			new FenetreNouveauProduit(this.controlleur);
		if (e.getSource() == btSupprimerProduit)
			new FenetreSuppressionProduit(this.controlleur.getListe(), this.controlleur);
//		if (e.getSource() == btNouvelleCategorie)
//			new FenetreNouvelleCategorie();
//		if (e.getSource() == btSupprimerCategorie)
//			new FenetreSuppressionCategorie(tabCategories);
		if (e.getSource() == btAchat)
			new FenetreAchat(this.controlleur.getListe(), this.controlleur);
		if (e.getSource() == btVente)
			new FenetreVente(this.controlleur.getListe(), this.controlleur);
